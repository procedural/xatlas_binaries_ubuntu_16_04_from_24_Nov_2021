...
ifeq ($(config),release_x86_64)
  ...
  OBJDIR = obj/x86_64/Release/bimg
  DEFINES += -DNDEBUG -DBIMG_DECODE_ENABLE=0
  INCLUDES += -I../../source/thirdparty/bx/include -I../../source/thirdparty/bimg/include
  FORCE_INCLUDE +=
...
ifeq ($(config),debug_x86_64)
  ...
  TARGET = $(TARGETDIR)/libbimg.a
  OBJDIR = obj/x86_64/Debug/bimg
  DEFINES += -D_DEBUG -DBIMG_DECODE_ENABLE=0
  INCLUDES += -I../../source/thirdparty/bx/include -I../../source/thirdparty/bimg/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
$(OBJDIR)/image.o: ../../source/thirdparty/bimg/src/image.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/image_gnf.o: ../../source/thirdparty/bimg/src/image_gnf.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
