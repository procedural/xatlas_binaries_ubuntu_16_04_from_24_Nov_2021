...
ifeq ($(config),release_x86_64)
  ...
  TARGET = $(TARGETDIR)/libstb_image_write.a
  OBJDIR = obj/x86_64/Release/stb_image_write
  DEFINES += -DNDEBUG
  INCLUDES +=
  FORCE_INCLUDE +=
...
ifeq ($(config),release_x86)
  ...
  TARGET = $(TARGETDIR)/libstb_image_write.a
  OBJDIR = obj/x86/Release/stb_image_write
  DEFINES += -DNDEBUG
  INCLUDES +=
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug_x86_64)
  ...
  TARGET = $(TARGETDIR)/libstb_image_write.a
  OBJDIR = obj/x86_64/Debug/stb_image_write
  DEFINES += -D_DEBUG
  INCLUDES +=
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug_x86)
  ...
  TARGET = $(TARGETDIR)/libstb_image_write.a
  OBJDIR = obj/x86/Debug/stb_image_write
  DEFINES += -D_DEBUG
  INCLUDES +=
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
$(OBJDIR)/stb_image_write.o: ../../source/thirdparty/stb_image_write.c
	@echo $(notdir $<)
