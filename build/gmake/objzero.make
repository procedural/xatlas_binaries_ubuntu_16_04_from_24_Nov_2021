...
ifeq ($(config),release_x86_64)
  ...
  TARGET = $(TARGETDIR)/libobjzero.a
  OBJDIR = obj/x86_64/Release/objzero
  DEFINES += -DNDEBUG
  INCLUDES +=
  FORCE_INCLUDE +=
...
ifeq ($(config),release_x86)
  ...
  TARGET = $(TARGETDIR)/libobjzero.a
  OBJDIR = obj/x86/Release/objzero
  DEFINES += -DNDEBUG
  INCLUDES +=
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug_x86_64)
  ...
  TARGET = $(TARGETDIR)/libobjzero.a
  OBJDIR = obj/x86_64/Debug/objzero
  DEFINES += -D_DEBUG
  INCLUDES +=
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -Og -g -std=c99
...
ifeq ($(config),debug_x86)
  ...
  TARGET = $(TARGETDIR)/libobjzero.a
  OBJDIR = obj/x86/Debug/objzero
  DEFINES += -D_DEBUG
  INCLUDES +=
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m32 -Og -g -std=c99
...
$(OBJDIR)/objzero.o: ../../source/thirdparty/objzero/objzero.c
	@echo $(notdir $<)
