...
ifeq ($(config),release_x86_64)
  ...
  TARGET = $(TARGETDIR)/libOpenFBX.a
  OBJDIR = obj/x86_64/Release/OpenFBX
  DEFINES += -DNDEBUG
  INCLUDES +=
  FORCE_INCLUDE +=
...
ifeq ($(config),release_x86)
  ...
  TARGET = $(TARGETDIR)/libOpenFBX.a
  OBJDIR = obj/x86/Release/OpenFBX
  DEFINES += -DNDEBUG
  INCLUDES +=
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug_x86_64)
  ...
  TARGET = $(TARGETDIR)/libOpenFBX.a
  OBJDIR = obj/x86_64/Debug/OpenFBX
  DEFINES += -D_DEBUG
  INCLUDES +=
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
$(OBJDIR)/miniz.o: ../../source/thirdparty/OpenFBX/miniz.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/ofbx.o: ../../source/thirdparty/OpenFBX/ofbx.cpp
	@echo $(notdir $<)
