...
ifeq ($(config),release_x86_64)
  ...
  TARGET = $(TARGETDIR)/libstb_image_resize.a
  OBJDIR = obj/x86_64/Release/stb_image_resize
  DEFINES += -DNDEBUG
  INCLUDES +=
  FORCE_INCLUDE +=
...
ifeq ($(config),release_x86)
  ...
  TARGET = $(TARGETDIR)/libstb_image_resize.a
  OBJDIR = obj/x86/Release/stb_image_resize
  DEFINES += -DNDEBUG
  INCLUDES +=
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug_x86_64)
  ...
  TARGET = $(TARGETDIR)/libstb_image_resize.a
  OBJDIR = obj/x86_64/Debug/stb_image_resize
  DEFINES += -D_DEBUG
  INCLUDES +=
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug_x86)
  ...
  TARGET = $(TARGETDIR)/libstb_image_resize.a
  OBJDIR = obj/x86/Debug/stb_image_resize
  DEFINES += -D_DEBUG
  INCLUDES +=
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
clean:
	@echo Cleaning stb_image_resize
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/stb_image_resize.o: ../../source/thirdparty/stb_image_resize.c
	@echo $(notdir $<)
